...
requestAnimationFrame(function loop() {
  const easting = 8;
  cursorBorderPosition.x +=
    (cursorPosition.x - cursorBorderPosition.x) / easting;
  cursorBorderPosition.y +=
    (cursorPosition.y - cursorBorderPosition.y) / easting;
...
const onWork4 = document.getElementsByClassName("fp-viewing-page-work-4");
const onWork5 = document.getElementsByClassName("fp-viewing-page-work-5");
  ...
  mutationList.forEach(function (mutation) {
    if (mutation.type === "attributes" && mutation.attributeName === "class") {
      ...
      if (onWork.length) {
        ...
        leftcircle.transform = "translateX(-50%)";
        leftcircle.backgroundColor = "var(--valotopcircle)";
        body.style.backgroundColor = "rgb(165, 162, 162)";
      ...
      if (onWork3.length) {
        ...
        leftcircle.backgroundColor = "orange";
        headercolor("white");
      }
      if (onWork4.length) {
        rightcircle.width = "130vmax";
